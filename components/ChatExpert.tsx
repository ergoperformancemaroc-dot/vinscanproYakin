...
const ChatExpert: React.FC<ChatExpertProps> = ({ companyName, appName }) => {
  const [messages, setMessages] = useState<ChatMessage[]>([
    { 
      role: 'model', 
      text: `Azul & Salam ! Je suis KHABIR (خبير / ⴰⵎⵓⵙⵏⴰⵡ), l'intelligence artificielle de ${appName || 'VIN SCAN PRO'}.\n\nJe suis à votre disposition pour l'identification technique, l'analyse VIN et les conseils d'importation.`, 
      timestamp: Date.now() 
    }
  ]);
      ...
      <div className="p-6 bg-slate-50 border-t border-slate-100">
        <div className="relative max-w-4xl mx-auto flex gap-3">
          <input
            ...
            placeholder="Interrogez Khabir / ⴰⵎⵓⵙⵏⴰⵡ..."
        ...
        <p className="text-[9px] text-center text-slate-400 mt-4 font-black uppercase tracking-widest">
          Khabir peut faire des erreurs • Vérifiez les informations critiques
        </p>
      </div>
    </div>
  );
